...
- (NSURL *)sourceURLForBridge:(RCTBridge *)bridge {
    if ([RinoDebugManager sharedInstance].debugOperationPanel == YES) {
        ...
        if ([panelManager checkShortcutPanelFileResource]) {
            resUrl = [panelManager getShortcutPanelResourceFilePath];
        }
        if (resUrl.length > 0) {
