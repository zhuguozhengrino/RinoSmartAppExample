...
RCT_CUSTOM_VIEW_PROPERTY(role, NSString, RinoIPCPlay) {
    ...
    NSLog(@"--Engine--view w:%f---view H:%f",view.frame.size.width,view.frame.size.height);
...
RCT_CUSTOM_VIEW_PROPERTY(style1, NSString, RinoIPCPlay){
    NSDictionary *styleDict = (NSDictionary *)json;
    NSLog(@"--Engine-style1:%@",[styleDict mj_JSONString]);
//    CGFloat width = [styleDict FloatForKey:@"width"];
//    CGFloat height = [styleDict FloatForKey:@"height"];
